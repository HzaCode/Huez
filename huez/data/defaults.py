...
def get_default_config() -> Config:
    ...
    scheme1 = Scheme(
        ...
        palettes=PalettesConfig(
            discrete="npg", sequential="viridis", diverging="vik", cyclic="twilight"
        ),
    ...
    scheme3 = Scheme(
        ...
        fonts=FontConfig(family="DejaVu Sans", size=9),
        palettes=PalettesConfig(
            discrete="nejm", sequential="cividis", diverging="RdBu", cyclic="twilight"
        ),
        figure=FigureConfig(size=[3.5, 2.5], dpi=300),
    ...
    bmj = Scheme(
        ...
        fonts=FontConfig(family="DejaVu Sans", size=9),
        palettes=PalettesConfig(
            discrete="bmj", sequential="viridis", diverging="RdBu", cyclic="twilight"
        ),
        figure=FigureConfig(size=[3.5, 2.5], dpi=300),
        style=StyleConfig(grid="y", legend_loc="best", spine_top_right_off=True),
    )

...
def simulate_cvd(rgb: Tuple[float, float, float], cvd_type: str) -> Tuple[float, float, float]:
    """
...
def color_distance(rgb1: Tuple[float, float, float], 
        ...
        if problematic:
            ...
            if verbose:
                ...
                for pair in problematic:
                    print(f"   {pair['color1']} ↔ {pair['color2']} (distance: {pair['distance']:.3f})")

...
class TestPaletteQualityChecks:
    ...
    def test_check_palette_quality_basic(self, mock_get_palette):
        ...
        mock_get_palette.return_value = [
            ...
            "#56B4E9",
            "#009E73",
            "#F0E442",  # Okabe-Ito colors
        ]

        scheme = Scheme(palettes=PalettesConfig(discrete="okabe-ito"))
    ...
    def test_check_palette_quality_specific_kinds(self, mock_get_palette):
        ...
        scheme = Scheme(
            palettes=PalettesConfig(discrete="test-palette", sequential="viridis")
        )
    ...
    def test_check_palette_quality_error_handling(self, mock_get_palette):
        ...
        scheme = Scheme(palettes=PalettesConfig(discrete="nonexistent"))
    ...
    def test_color_validation(self):
        ...
        for color in invalid_colors:
            if color.startswith("#") and len(color) == 7:
                ...
                invalid_chars = [
                    c for c in color[1:] if c not in "0123456789ABCDEFabcdef"
                ]
                if invalid_chars:
...
class TestFigureLinting:
    ...
    def test_lint_figure_file_with_report(
        self, mock_file, mock_np_array, mock_image_open, mock_path
    ):
...
class TestQualityReporting:
    ...
    def test_quality_report_structure(self, mock_get_palette):
        ...
        scheme = Scheme(palettes=PalettesConfig(discrete="test-palette"))
...
class TestQualityIntegration:
    ...
    def test_end_to_end_quality_check(self, mock_get_palette):
        ...
        mock_get_palette.side_effect = lambda name, kind: {
            ("okabe-ito", "discrete"): ["#E69F00", "#56B4E9", "#009E73", "#F0E442"],
            ("viridis", "sequential"): ["#440154", "#31688e", "#35b779", "#fde725"],
        }.get((name, kind), ["#FF0000", "#00FF00", "#0000FF"])

        scheme = Scheme(
            palettes=PalettesConfig(discrete="okabe-ito", sequential="viridis")
        )
